...
const VAZHI_CHILDREN = [
  ...
  { vazhi_id: 27, name: "பொய்கை ஆழ்வார்" },
  { vazhi_id: 28, name: "பூதத்தாழ்வார்" },
  { vazhi_id: 29, name: "பேயாழ்வார்" },
  { vazhi_id: 30, name: "திருமழிசை ஆழ்வார்" },
  { vazhi_id: 31, name: "மதுரகவி ஆழ்வார்" },
  { vazhi_id: 32, name: "பெரியாழ்வார்" },
  { vazhi_id: 33, name: "குலசேகராழ்வார்" },
  { vazhi_id: 34, name: "தொண்டரடிப்பொடி ஆழ்வார்" },
  { vazhi_id: 35, name: "திருப்பாணாழ்வார்" },
  { vazhi_id: 36, name: "திருமங்கை ஆழ்வார்" }
];
